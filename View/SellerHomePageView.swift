...
struct QuickActionGridView: View {
    ...
    var body: some View {
        LazyVGrid(columns: columns, spacing: 16) {
            QuickActionCard(title: "Buyers", imageName: "person.2.fill")

            // This is the key change: NavigationLink is added here
            NavigationLink(destination: SellersListView()) {
                 QuickActionCard(title: "Sellers", imageName: "person.badge.plus")
            }

            QuickActionCard(title: "BIDS", imageName: "gavel.fill")
            QuickActionCard(title: "Offers", imageName: "tag.fill")
        }
    }
}
